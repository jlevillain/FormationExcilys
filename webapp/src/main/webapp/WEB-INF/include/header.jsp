...
<script src="<c:url value="/resources/development-bundle/ui/i18n/jquery-ui-i18n.js"/>"></script>
<script src="<c:url value="/resources/development-bundle/ui/i18n/jquery.ui.datepicker-fr.js"/>"></script>
</head>
<body>
	<noscript>
		<h1>
	...
	<header class="navbar navbar-inverse">
		<h1 class="fill">
			...
			<a href="?lang=en"><img src='<c:url value="/resources/images/anglais.png"/>'/></a> | 
			<a href="?lang=fr"><img src='<c:url value="/resources/images/francais.png"/>'/></a>
			</span>
