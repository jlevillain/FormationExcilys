...
if(MyApp.view.login.Login){
    Ext.apply(MyApp.view.login.Login.prototype, {
         username:"Username",
         password:"Password",
         hideEmptyLabel:"Enter any non-blank password",
         buttonLogin:"Connexion",
         loginTitle:"Fenêtre de connexion"
    });
}
if(MyApp.Application){
    Ext.apply(MyApp.Application.prototype, {
        browerSupport:"Your Browser Does Not Support Local Storage"
    });
}
if(MyApp.controller.MainController) {
    Ext.apply(MyApp.controller.MainController.prototype, {
        disconnectButton:"Logout"
    });
}
if(MyApp.view.login.LoginController) {
     Ext.apply(MyApp.view.login.LoginController.prototype ,{
...
if(MyApp.view.home.HomeController) {
    Ext.apply(MyApp.view.home.HomeController.prototype, {
        confirm:"Confirmer",
        confirmQuestion:"Etes vous sûre ?"
    });
}
...
if(MyApp.view.login.Login){
    Ext.apply(MyApp.view.login.Login.prototype, {
         ...
         hideEmptyLabel:"Entrer un mot de passe non vide",
         buttonLogin:"Connexion",
         loginTitle:"Fenêtre de connexion"
    });
}
if(MyApp.Application){
    Ext.apply(MyApp.Application.prototype, {
        browerSupport:"Votre navigateur ne supporte pas le stockage local"
    });
}
if(MyApp.controller.MainController) {
    Ext.apply(MyApp.controller.MainController.prototype, {
...
if(MyApp.view.login.LoginController) {
    Ext.apply(MyApp.view.login.LoginController.prototype ,{
        errorMessage:"Login ou mot de passe erronées"
    })
}
*/
